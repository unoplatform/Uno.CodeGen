...
``` csharp
#error: 'ImmutableGenerator: Property MyClass.SomeField (ClassBase) is not immutable. It cannot be used in an immutable entity.'
```

To fix this, put this attribute on your assembly:

``` csharp
[assembly: Uno.TreatAsImmutable(typeof(ClassBase))]
```
